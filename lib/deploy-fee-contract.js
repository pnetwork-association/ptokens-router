...
const deployFeeContract = (_nodeOperatorsFeeSink, _networkFeeSink, _pegInBasisPoints, _pegOutBasisPoints) =>
  console.info('✔ Deploying fee contract...') ||
  getEnvConfiguration()
    ...
    .then(_factory =>
      deployEthersContract(
        _factory,
        [ _nodeOperatorsFeeSink, _networkFeeSink, _pegInBasisPoints, _pegOutBasisPoints ]
      )
    )
