const VERSION_1_BYTE = '0x01'
const VERSION_2_BYTE = '0x02'
const VERSION_3_BYTE = '0x03'
...
const encodeV1Metadata = (_codec, _userData, _originChainId, _originAddress) =>
  ...
  _codec.encode(METADATA_PARAMS_V1, [ VERSION_1_BYTE, _userData, _originChainId, _originAddress ])
...
const encodeCoreMetadata = (
  ...
  new Promise((resolve, reject) => {
    ...
    } else if (_version === null || _version === VERSION_2_BYTE) {
    ...
    } else if (_version === VERSION_3_BYTE) {
