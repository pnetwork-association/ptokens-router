...
const getSafeVaultContractAbi = _ => getKeyFromContractArtifact('abi', 'SafeVault')
const getRouterContractBytecode = _ => getKeyFromContractArtifact('bytecode', 'Router')
const getSafeVaultContractBytecode = _ => getKeyFromContractArtifact('bytecode', 'SafeVault')
